...
In addition to published `R` libraries, this notebook uses a set of functions especially created for manipulating RIMReP data collections. These functions are available in the `useful_spatial_functions_data_extraction.R` script, which **must** exist in the same directory where this notebook is located.
