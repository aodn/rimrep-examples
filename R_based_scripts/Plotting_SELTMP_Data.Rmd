...
Our data is now ready for us to make a plot. We will order our plot by the mean percentage of people reporting performing an activity. Higher proportions will be on the left and decrease to the right.  
...
More work needs to be done in cleaning this dataset. However, since there are over 1,000 rows with responses, it is beyond the scope of this notebook to complete harmonise the answers in the dataset. For now, we will move on to plotting the results.  
  
Note that you will need to run this notebook in your local machine to see the results of the wordcloud.  
