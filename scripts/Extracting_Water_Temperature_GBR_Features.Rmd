...
In addition to published `R` libraries, this notebooks will use a set of functions especially created for manipulating RIMReP dtaa collections. These functions are available in the `useful_spatial_functions_data_extraction.R` script, which **must** exist in the same directory where this notebook is located.
