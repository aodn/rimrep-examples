...
**Note:** One location (`GBR_NAME`) may contain multiple values under the `UNIQUE_ID` column. This is above water structures may not appear connected when looking at the surface, but they are part of the same structure and thus are connected under water.
